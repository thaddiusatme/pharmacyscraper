...
from src.pharmacy_scraper.classification.models import (
    PharmacyData, 
    ClassificationResult,
    ClassificationSource
)
from src.pharmacy_scraper.classification.classifier import Classifier
from src.pharmacy_scraper.classification.perplexity_client import PerplexityClient
...
class TestClassificationWorkflow:
    ...
    def setup_method(self):
        ...
        from src.pharmacy_scraper.classification.classifier import _classification_cache
    ...
    @patch('src.pharmacy_scraper.classification.perplexity_client.PerplexityClient.classify_pharmacy')
    ...
    def test_end_to_end_with_perplexity_client(self):
        ...
        with patch('src.pharmacy_scraper.classification.perplexity_client.PerplexityClient.classify_pharmacy') as mock_classify:
    ...
    def test_batch_classification(self):
        ...
        with patch('src.pharmacy_scraper.classification.perplexity_client.PerplexityClient._call_api'):
